...
git clone <ICARUS_REPOSITORY_URL>
cd icarus-fsw-demo
...
The Open MCT historical telemetry plugin is intentionally disabled.
...
The bridge listens for telemetry from the C OBC on:

UDP :5000

and provides the live WebSocket connection on:

WebSocket :8765
Terminal 3 — Start the C OBC
...
The reported thermal telemetry is forced to:
...
The reported battery telemetry is forced to:
